<?php 
/**
 * Social Wiggle - Social network chooser on settings page
 *
 * @author 	Brad Vincent
...
<table id="socwig-sort" class="widefat socwig-container socwig-32 socwig-table" cellspacing="0">
	...
	<?php foreach ($socwig_actual_sortorder as $class) {
		...
		<tr id="<?php echo $class; ?>" class="<?php echo $disabled; ?>">
			...
			<td>
				<i title="<?php echo $name; ?>" class="socwig-dragme socwigbtn socwig-<?php echo $class; ?>"></i><span><?php echo $name; ?></span>
			</td>
			<td>
				<input style="width:300px" value="<?php echo $url; ?>" name="socialwiggle[networks][<?php echo $class; ?>-url]" />
			</td>
			<td>
				<input style="width:200px" value="<?php echo $tooltip; ?>" name="socialwiggle[networks][<?php echo $class; ?>-tooltip]" />
			</td>
		</tr>
	<?php } ?>
	</tbody>
